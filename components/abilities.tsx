export const AblilityAny = (color: string): JSX.Element => {
	return (
		<svg
			width='120'
			height='120'
...
export const AbilityBranch = (color: string): JSX.Element => {
	return (
		<svg
			width='120'
			height='120'
...
export const AbilityDouble = (color: string): JSX.Element => {
	return (
		<svg
			width='120'
			height='120'
...
export const AbilityRepeat = (color: string): JSX.Element => {
	return (
		<svg
			width='120'
			height='120'
